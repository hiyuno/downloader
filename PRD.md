...
| 2026-07-27 | Idioma de la UI cambiado de español a inglés — sigue siendo "un solo idioma" (sección Features fuera del MVP: sin localización a otros idiomas en v1) | Pedido directo del usuario. Se tradujeron todos los strings visibles (UI, accesibilidad, notificaciones, menú de la barra de menú) y se quitó "Buscar actualizaciones…" del menú; comentarios de código y logs de desarrollador se dejaron en español, son documentación interna, no interfaz |
